...
class Google_Service_Monitoring_Resource_ProjectsNotificationChannels extends Google_Service_Resource
{
   ...
   * The format is: projects/[PROJECT_ID] Note that this names the container into
   ...
   * The format is projects/[PROJECT_ID]/notificationChannels/[CHANNEL_ID].
   * @param array $optParams Optional parameters.
   *
   ...
   *
   * @param string $name Required. The project on which to execute the request.
   * The format is projects/[PROJECT_ID]. That is, this names the container in
