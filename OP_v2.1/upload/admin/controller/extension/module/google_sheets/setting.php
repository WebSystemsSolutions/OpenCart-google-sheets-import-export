...
class ControllerExtensionModuleGoogleSheetsSetting extends Controller
{
    ...
    public function index()
    {
        ...
        $this->response->setOutput($this->load->view('extension/module/google_sheets/setting.tpl', $data));
    }
    ...
    private function loadTabExport(&$data)
    {
        ...
        $data['tab_export'] = $this->load->view('extension/module/google_sheets/tab_export.tpl', $data);
    }
    ...
    private function loadTabImport(&$data)
    {
        ...
        $data['tab_import'] = $this->load->view('extension/module/google_sheets/tab_import.tpl', $data);
    }
    ...
    private function loadTabSetting(&$data)
    {
        ...
        $data['tab_setting'] = $this->load->view('extension/module/google_sheets/tab_setting.tpl', $data);
    }
    ...
    private function loadModuleInfoData(&$data)
    {
        ...
        $data['action'] = $this->url->link('extension/module/google_sheets/setting', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/google_sheets/setting', 'token=' . $this->session->data['token'], 'SSL')
        );
